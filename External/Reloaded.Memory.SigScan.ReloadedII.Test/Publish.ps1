...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "Reloaded.Memory.SigScan.ReloadedII.Test.csproj",
    $PackageName = "Reloaded.Memory.SigScan.ReloadedII.Test",
    ...
    $NuGetPackageId = "Reloaded.Memory.SigScan.ReloadedII.Test",
