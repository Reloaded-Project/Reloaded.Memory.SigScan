...
namespace Reloaded.Memory.Sigscan.Benchmark.Benchmarks.LargeArray
{
    public class OtherLargeArrayBenchmarks : LargeArrayBenchmarkBase
    {
        ...
        {
            var result = _scannerFromFile.CompiledFindPatternSse2("D7 9F 43 63 68 43");
            return result.Offset;
        }
        ...
        {
            var result = _scannerFromFile.CompiledFindPatternSse2("D7 9F 43 63");
            return result.Offset;
        }
        ...
        {
            var result = _scannerFromFile.CompiledFindPatternSse2("9F 43 63 68 43 4F 99 A7 15 48");
            return result.Offset;
        }
